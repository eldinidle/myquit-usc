...
public class MyQuitRandomSurvey {
    ...
    public static final String[] othersSmoke = {"Were others smoking or vaping around you when the phone went off?",
    "Yes - smoking", "Yes - vaping", "Yes - both", "No"};
    public static final String[] allowSmoke = {"Is smoking or vaping allowed where you are at when the phone went off?",
    "Yes - smoking", "Yes - vaping", "Yes - both", "No"};
