        ...
        protected String doInBackground(String[]... params) {
            ...
            switch(surveyType){
                ...
                case MyQuitEndOfDaySurvey.KEY_SURVEY_SUCCESS:
                    ...
                    emaParams.add(new BasicNameValuePair("naHopeless", params[0][6]));
                    emaParams.add(new BasicNameValuePair("naIrritable", params[0][7]));
                    emaParams.add(new BasicNameValuePair("naSad", params[0][8]));
                    emaParams.add(new BasicNameValuePair("naScared", params[0][9]));
                    emaParams.add(new BasicNameValuePair("naTense", params[0][10]));
                    emaParams.add(new BasicNameValuePair("naUpset", params[0][11]));
                    emaParams.add(new BasicNameValuePair("paCheerful", params[0][12]));
                    emaParams.add(new BasicNameValuePair("paEnthusiastic", params[0][13]));
                    emaParams.add(new BasicNameValuePair("paHappy", params[0][14]));
                    emaParams.add(new BasicNameValuePair("paInterested", params[0][15]));
                    emaParams.add(new BasicNameValuePair("paProud", params[0][16]));
                    emaParams.add(new BasicNameValuePair("troubleCigs", params[0][17]));
                    emaParams.add(new BasicNameValuePair("botherDesire", params[0][18]));
                    emaParams.add(new BasicNameValuePair("frequentUrges", params[0][19]));
                    emaParams.add(new BasicNameValuePair("confidentQuit", params[0][20]));
                    emaParams.add(new BasicNameValuePair("helpQuit", params[0][21]));
                    emaParams.add(new BasicNameValuePair("vapeCig", params[0][22]));
                    emaParams.add(new BasicNameValuePair("vapeCigCount", params[0][23]));
                    emaParams.add(new BasicNameValuePair("vapePuffCount", params[0][24]));
                    emaParams.add(new BasicNameValuePair("anhedoniaPeople", params[0][25]));
                    emaParams.add(new BasicNameValuePair("anhedoniaHobby", params[0][26]));
                    emaParams.add(new BasicNameValuePair("anhedoniaSocial", params[0][27]));
                    break;
    ...
    public static boolean syncEMAEvent(String[] params)  {
        ...
        switch(surveyType){
            ...
            case MyQuitEndOfDaySurvey.KEY_SURVEY_SUCCESS:
                ...
                emaParams.add(new BasicNameValuePair("naHopeless", params[6]));
                emaParams.add(new BasicNameValuePair("naIrritable", params[7]));
                emaParams.add(new BasicNameValuePair("naSad", params[8]));
                emaParams.add(new BasicNameValuePair("naScared", params[9]));
                emaParams.add(new BasicNameValuePair("naTense", params[10]));
                emaParams.add(new BasicNameValuePair("naUpset", params[11]));
                emaParams.add(new BasicNameValuePair("paCheerful", params[12]));
                emaParams.add(new BasicNameValuePair("paEnthusiastic", params[13]));
                emaParams.add(new BasicNameValuePair("paHappy", params[14]));
                emaParams.add(new BasicNameValuePair("paInterested", params[15]));
                emaParams.add(new BasicNameValuePair("paProud", params[16]));
                emaParams.add(new BasicNameValuePair("troubleCigs", params[17]));
                emaParams.add(new BasicNameValuePair("botherDesire", params[18]));
                emaParams.add(new BasicNameValuePair("frequentUrges", params[19]));
                emaParams.add(new BasicNameValuePair("confidentQuit", params[20]));
                emaParams.add(new BasicNameValuePair("helpQuit", params[21]));
                emaParams.add(new BasicNameValuePair("vapeCig", params[22]));
                emaParams.add(new BasicNameValuePair("vapeCigCount", params[23]));
                emaParams.add(new BasicNameValuePair("vapePuffCount", params[24]));
                emaParams.add(new BasicNameValuePair("anhedoniaPeople", params[25]));
                emaParams.add(new BasicNameValuePair("anhedoniaHobby", params[26]));
                emaParams.add(new BasicNameValuePair("anhedoniaSocial", params[27]));
                break;
            case MyQuitOffSuccessSurvey.KEY_SURVEY_SUCCESS:
                break;
            case MyQuitRandomSurvey.KEY_SURVEY_SUCCESS:
