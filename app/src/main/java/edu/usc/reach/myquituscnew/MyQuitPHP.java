...
import edu.usc.reach.myquituscnew.Surveys.MyQuitCalendarSuccessSurvey;
import edu.usc.reach.myquituscnew.Surveys.MyQuitCheckSuccessSurvey;
import edu.usc.reach.myquituscnew.Surveys.MyQuitEndOfDaySurvey;
import edu.usc.reach.myquituscnew.Surveys.MyQuitOffSuccessSurvey;
import edu.usc.reach.myquituscnew.Surveys.MyQuitPreQuitEndOfDaySurvey;
import edu.usc.reach.myquituscnew.Surveys.MyQuitRandomSurvey;
import edu.usc.reach.myquituscnew.Surveys.MyQuitSmokeSurvey;
        ...
        protected String doInBackground(String[]... params) {
            ...
            switch(surveyType){
                ...
                case MyQuitEndOfDaySurvey.KEY_SURVEY_SUCCESS:
                    ...
                    emaParams.add(new BasicNameValuePair("anhedoniaPeople", params[0][17]));
                    emaParams.add(new BasicNameValuePair("anhedoniaHobby", params[0][18]));
                    emaParams.add(new BasicNameValuePair("anhedoniaSocial", params[0][19]));
                    emaParams.add(new BasicNameValuePair("troubleCigs", params[0][20]));
                    emaParams.add(new BasicNameValuePair("botherDesire", params[0][21]));
    ...
    public static boolean syncEMAEvent(String[] params)  {
        ...
        switch(surveyType){
            ...
            case MyQuitEndOfDaySurvey.KEY_SURVEY_SUCCESS:
                ...
                emaParams.add(new BasicNameValuePair("anhedoniaPeople", params[17]));
                emaParams.add(new BasicNameValuePair("anhedoniaHobby", params[18]));
                emaParams.add(new BasicNameValuePair("anhedoniaSocial", params[19]));
                emaParams.add(new BasicNameValuePair("troubleCigs", params[20]));
                emaParams.add(new BasicNameValuePair("botherDesire", params[21]));
